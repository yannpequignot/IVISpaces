...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        mlflow.log_artifact('Results/GeNmodels.pt')
        
        models=GeNmodels
        results={}

        for d in datasets:
                metrics=run_metrics(d,'GeNNeVI') 
                print(d+': done :-)')
                results.update(metrics)
                torch.save(results, 'Results/GeNmetrics.pt')
                
        mlflow.log_artifact('Results/GeNmetrics.pt')
